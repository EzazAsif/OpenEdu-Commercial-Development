...
CommChatSocket.onopen = function () {
  ...
  try {
    ...
    <div class="flex items-end justify-end px-4 py-2">
      <div class="flex flex-col items-end max-w-[80%] space-y-1">
        ...
        <div class="bg-green-100 text-gray-900 px-3 py-2 rounded-xl rounded-br-sm shadow-sm text-sm leading-tight whitespace-pre-wrap break-words">
    ...
    <div class="flex items-start relative px-6 py-3">
      ...
      <div class="ml-3 flex flex-col max-w-sm">
        ...
        <div class="bg-yellow-100 text-yellow-900 text-sm px-3 py-2 rounded-xl rounded-tl-none shadow break-words whitespace-pre-wrap leading-tight">
          ${escapeHtml(data.message)}
        </div>
      </div>
    </div>
...
// Optional helper to keep scroll at bottom
